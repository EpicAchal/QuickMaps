...
using winmaps.Helpers;
using winmaps.Services;

namespace winmaps.Views
{
    
    public sealed partial class WorldPage : Page, INotifyPropertyChanged
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            if (mapControl != null)
            {
                ...
                mapControl.MapServiceToken = "jxddEZHqI2WIuWTjXwt7~0Qonw9PU1ZxTU4EgGOJ0iw~AlYIcRRwNSCrtEC2WxifOMjBITX80MHgPum1UrRdRKcbQvMJt3owDKTNOqGQ1sU0";
